...
**Time & Materials** — Integration and implementation are billed hourly. This covers the setup work: connecting your existing systems, configuring the environment, and making sure everything talks to everything else. Don’t worry, our developers work faster than your accounting department can approve invoices.

**License-Based** — Once everything is up and running, you pay for licenses based on which members of our digital “family” you want working for you. No per-module fees, no surprise add-ons.
...
[Get Your Personalized Quote](/about/contacts/) — because your business is unique, and so should be your pricing. You tell us the outcomes you want. We assemble the right team members to deliver those outcomes. Simple as that.

<p>* All prices are exclusive of applicable taxes. Prices shown are for reference only; your actual quote may vary based on specific requirements and customizations.</p>

<p>** In some regions, licenses are available through our certified distribution partners. If you’re based in MENA, Europe, or Asia, your local partner can handle procurement, invoicing, and first-line support in your timezone. See <a href="/about/contacts/#buy-through-a-partner">the full partner list</a>.</p>
