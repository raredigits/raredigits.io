...
**Legend:**
- `✅` Published
- `📝` Gap — can be written retroactively or skipped
- `→` Planned (future)
...
### Sep 2023
`✅` **Leverage of Affiliate Programs** — Standalone
...
### May 2024
`✅` **Website Security: You're Not That Interesting** — Standalone
Published: 2024-05-06

### Jun 2024
`✅` **How to Determine if You Need to Urgently Invest in AI** — Standalone
...
The default settings are designed for the median client. Your business is not the median client. The customizations that would actually help are in the premium tier.
...
Every quarter a new model is "best in class." We've integrated enough of them to know what that phrase means in practice.
...
`✅` **Big Checks vs. Frequent Buyers** — Standalone
Published: 2025-01-20 *(two in January — treat as a bonus)*

### Feb 2025
`📝` **We're AI-Agnostic, Part 3: The Real Cost of Model Lock-In** — [AI]
Switching the underlying model shouldn't require rewriting your product. If it does, the architecture is the problem. We learned this the expensive way.
...
Took a one-year loan, payback is three years. Short-term assets vs. liabilities mismatch is how solvent businesses become insolvent ones. The warning signs are there before the crisis.
...
Discounted cash flow is not a finance department exercise. It's the right way to think about any decision with a time horizon. Here's the version that takes ten minutes.

### Aug 2025
`📝` **Where Your Money Actually Goes, Part 6: Financial Leverage** — [Finance]
