...
<section class="lead">Ninety-nine of every hundred CRMs on the market are the same program wearing different colours. A board of cards, five tidy columns with names like Qualified and Proposal and Won, and your whole job is to drag a little card one column to the right whenever something good happens. It costs about $5 a seat, and for this price it is honestly fine. It is also a polite lie about how selling actually works.</section>

<div class="text-content-fullwidth-caption">
    <div>{% include "special/constructionNotice.html" %}</div>
    <cite>The whole relationship in one place. <a href="/demo/columbus/clients/">Open the live demo →</a></cite>
</div>
...
<div class="highlight">You can be late with the deck. You cannot be late wishing her daughter a happy birthday. One of those is in your job description. The other is the job.</div>

## What We Built Instead of a Sixth Column
...
<div class="highlight">Most software helps you take more from a relationship. This is the rare one that tells you when you have taken too much.</div>

## The Client Who Argues Your Case
...
<div class="highlight">The cheapest sale you make this year is the second one, to someone who already trusts you. The second cheapest is to the friend they introduce you to, once you have earned the introduction.</div>
...
<div class="caption">→ <a href="/demo/columbus/clients/">Open the live Columbus demo</a></div>
